...
export function FinalizeShop({carProducts, form, methodPay, methodsPay, open, setOpen, handleSelectMethodPay, handleChange, handleRegisterVenta}) {
    return (
        <div>
            <div class="modal fade modal-xl h-30" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
